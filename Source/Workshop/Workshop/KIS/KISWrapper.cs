...
namespace Workshop.KIS
{
    ...
    public class KIS_Item
    {
        ...
        static FieldInfo kis_availablePart;
        static FieldInfo kis_icon;
        static MethodInfo kis_GetResources;
        static MethodInfo kis_SetResource;
        static MethodInfo kis_EnableIcon;
        ...
        public AvailablePart availablePart
        {
            get
            {
                return kis_availablePart.GetValue(obj) as AvailablePart;
            }
        }

        public void EnableIcon(int resolution)
        {
            kis_EnableIcon.Invoke(obj, resolution);
        }
    ...
    {
        static Type KIS_IconViewer_Class;
        static FieldInfo kis_texture;
        ...
        public Texture texture
        {
            get
            {
                return kis_texture.GetValue(obj) as Texture;
            }
        }
        ...
        internal static void Initialize(Assembly KISasm)
        {
            KIS_IconViewer_Class = KISasm.GetTypes().Where(t => t.Name.Equals("KIS_IconViewer")).FirstOrDefault();
